...
public:
    ...
    Location GenLoadConstant(int value, const Type &type);
    Location GenLoadConstant(const string &str);
    ...
    void GenAssign(const Location &dst, const Location &src);
    ...
    void GenStore(const Location &addr, const Location &val, int offset = 0);
    ...
    Location GenLoad(const Location &addr, int offset, const Type &type);
    ...
    // was stored.
    Location GenBinaryOp(const BinaryOp::OpCode &operation,
                         const Location &op1,
                         const Location &op2);
    ...
    void GenPushParam(const Location &param);
    ...
    void GenLCallVoid(const string &label);
    Location GenLCallVal(const string &label, const Type &type);
    ...
    void GenACallVoid(const Location &fnAddr);
    Location GenACallVal(const Location &fnAddr, const Type &type);
    ...
    // Location GenBuiltInCall(BuiltIn b,
    //                         const Location &arg1,
    //                         const Location &arg2);
    ...
    // return a value
    void GenIfZ(const Location &test, const string &label);
    void GenGoto(const string &label);
    void GenReturn();
    void GenReturn(const Location &val);
    ...
    void GenVTable(const string &className, const vector<string> &methodLabels);
